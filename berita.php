...
?>
    ...
    <head>
        ...
        <title>Admin - HiperJobMedan</title>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        <a href="berita_tambah.php" class="btn btn-info pull-right"><i class="fa fa-plus"></i></a>
                                                ...
                                                <form method="GET" action="berita.php">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="myModalLabel">Masukkan Nama Berita</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label>Nama Berita</label>
                                                                <input type="text" class="form-control border-input" name="nama" placeholder="Deskripsi Inpirasi" />
                                                            </div>
                                                        </div>
                                        ...
                                        <?php
                                            if(isset($_GET['nama'])){
                                        ?>
                                            <a href="berita.php" class="btn btn-info pull-right" style="margin-right: 8px;"><i class="fa fa-arrow-left"></i></a>
                                            <?php
                                            }
                                        ?>
                                                <h4 class="title">Data Tips & Berita</h4>
                                                <p class="category">List dari semua Berita</p>
                                    </div>
                                    ...
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($_GET['nama'])){
                                                        $strQuery = "SELECT berita_id, nama, judul, deskripsi, gambar FROM berita WHERE deskripsi LIKE '%$_GET[nama]%' ORDER BY berita_id ASC";
                                                    }else {
                                                        $strQuery = "SELECT berita_id, nama, judul, deskripsi, gambar FROM berita ORDER BY berita_id ASC";
                                                    }
                                                    $query = mysqli_query($connection, $strQuery);
                                                    $i = 0;
                                                    while($result = mysqli_fetch_assoc($query)){
                                                        echo "<tr>";
                                                        echo "<td>$result[berita_id]</td>";
                                                         echo "<td>$result[nama]</td>";
                                                          echo "<td>$result[judul]</td>";
                                                        echo "<td>$result[deskripsi]</td>";
                                                        echo "<td>$result[gambar]</td>";
                                                        echo "<td><a href='berita_edit.php?id=$result[berita_id]'>Edit</a>";
                                                        echo "&nbsp;&nbsp;&nbsp;";
                                                ...
                                                ?>
                                                    ...
                                                    <div class="modal fade " id="delete<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        <div class="modal-dialog modal-sm" role="document">
                                                            <form method="POST" action="php/berita_delete_proses.php">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <input type="hidden" name="id" value="<?php echo " $result[berita_id] ";?>" />
