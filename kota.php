...
?>
    ...
    <head>
        ...
        <title>HIPERSHOP - JOB VACANCY</title>
                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Kabupaten / Kota</a>
                        </div>
                                ...
                                <div class="card">
                                    <div class="header">
                                        ...
                                        ?>
                                                ...
                                                <p class="category">List dari semua Kabupaten / Kota</p>
                                    </div>
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($_GET['nama'])){
                                                        $strQuery = "SELECT kota_id, kota_nama FROM kota WHERE kota_nama LIKE '%$_GET[nama]%' ORDER BY kota_id ASC";
                                                    }else {
                                                        $strQuery = "SELECT kota_id, kota_nama FROM kota ORDER BY kota_id ASC";
                                                    }
